...
IF (CMAKE_COMPILER_IS_GNUCXX OR "x${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang") # g++/Clang
    ...
    if (MINGW)
        ...
        # Position-independent code is not a concept on Windows targets, and
        # clang rejects the flag outright there ("unsupported option '-fPIC' for
        # target 'x86_64-pc-windows-msvc'"). This block runs for any compiler
        # reporting id Clang, which on Windows includes both clang-cl and the
        # GNU-driver clang++ that ships with Visual Studio, so guarding on MINGW
